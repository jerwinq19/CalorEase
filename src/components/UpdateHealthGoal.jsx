...
const UpdateHealthGoal = ({maxCalories}) => {
        ...
        <>
            <div className="w-full max-w-3xl bg-white rounded-2xl p-6 shadow-lg">
                ...
                <div className="mt-8 bg-gray-100 rounded-xl p-6 text-sm text-gray-700 space-y-2">
                    ...
                    <p>
                        <span className="font-medium">Current Weight:</span> {weight || "N/A"} kg
                    </p>
                    <p>
                        <span className="font-medium">Target Weight:</span> {target || "N/A"} kg in {timeframe || "N/A"} weeks
                    </p>
                    <p>
                        <span className="font-medium">Activity Level:</span> {actLevel || "N/A"}
                    </p>
                    <p>
                        <span className="font-medium">Diet Preference:</span> {diet || "N/A"}
                    </p>
